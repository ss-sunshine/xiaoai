    ...
    <el-tabs v-model="activeName">
      <el-tab-pane :label="`未读消息(${total})`" name="first">
        <div class="backgroud">
          ...
          <el-button :data="arr" type="primary" class="btn" @click="clickItem4(item,index)">全部标为已读</el-button>
        </div>
      </el-tab-pane>
          ...
          <div>
            ...
            >
              ...
              <el-table-column width="110">
                <template slot-scope="scope">
                  <el-button :data="arr1" @click="clickItem2(scope.$index, scope.row)">删除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
          <el-button type="danger" class="btn" @click="clickItem5(item,index)">删除全部</el-button>
        </div>
      </el-tab-pane>
