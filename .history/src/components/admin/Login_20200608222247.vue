<template>
    <div class="login-box f-c-a-j">
      <h4 class="m-b-4">欢迎来到小爱后台管理系统</h4>
      <div class="login">
        <el-form
          :model="ruleForm"
          :rules="rules"
        ...
        >
          ...
          <el-form-item label="请输入密码" prop="password" class="f-j-bw">
            <el-input v-model="ruleForm.password" show-password class="password"></el-input>
          </el-form-item>
